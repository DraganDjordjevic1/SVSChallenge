...
namespace SVSCRUDASP.Controllers
{
    public class OwnersController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "OwnerID,GivenName,Surname,Phone")] Owner owner)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "OwnerID,GivenName,Surname,Phone")] Owner owner)
        {
            if (ModelState.IsValid)
            {
